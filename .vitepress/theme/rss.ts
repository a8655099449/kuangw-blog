...
const AUTHOR = {
  name: "kuangw",
  email: "kuangw96@gmail.com",
  link: DOMAIN,
};
const OPTIONS: FeedOptions = {
  title: "kuangw",
  description: "kuangw' Blog",
  id: `${DOMAIN}/`,
  link: `${DOMAIN}/`,
  ...
  author: AUTHOR,
  image: "https://s2.loli.net/2022/12/13/vVFejXUpPTcCIsM.png",
  favicon: "https://s2.loli.net/2022/12/13/vVFejXUpPTcCIsM.png",
};
